...
class Milestone5Window(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("CloudSync Insight - Milestone 5")

        self.status = QLabel("Status: Idle")
        self.progress = QProgressBar()
        self.progress.setValue(0)

        self.btn = QPushButton("Run Sync (Milestone 5 Demo)")
    ...
    def run_sync(self):
        ...
        log_event("Sync started (Milestone 5)")
        ...
        QMessageBox.information(self, "Milestone 5", "Sync finished.\nLog written to sync_log.txt")
